...
//    }
    ...
    public void testIsEditing() {
        ...
        Figure existingFigure = new SVGTextFigure();
        TextEditingTool instance = new TextEditingTool((TextHolderFigure) existingFigure);
        boolean expResult = true;
        boolean result = instance.isEditing();
        assertEquals(expResult, result);
        
        existingFigure = null;
        instance = new TextEditingTool((TextHolderFigure) existingFigure);
        expResult = false;
        result = instance.isEditing();
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
    }
